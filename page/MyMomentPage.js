  ...
  render()
  {
	...
	<ScrollView>
	  <View style={{flexDirection:'column',flex:1}}>
	      <View style={{flexDirection:'row',flex:2,backgroundColor:'gray'}}>
	        <View style={{flex:2}}/>
		    ...
		    <View style={{flexDirection:'column',flex:1}}>
		      <View style={{height:80,flexDirection:'row'}}>
			    <View style={{width:80,alignItems:'center',justifyContent:'center',flex:1}}>
			      <Text style={{fontSize:18,color:'black'}}>今天</Text>
			    </View>
			    <View style={{alignItems:'flex-start',justifyContent:'center',flex:4}}>
			      <TouchableHighlight onPress={()=>navigate('WriteMoment')} underlayColor="#eee">
				    <View style={styles.newAct}>
				      <Text style={{color:'white'}}>发布动态</Text>
				    </View>
				  </TouchableHighlight>
			    </View> 
			  </View>
  ...
  _renderItem = (item) => {
        ...
        return (
		  <View style={{flexDirection:'row'}}>
		    <View style={{flex:1,alignItems:'center',justifyContent:'flex-start',height:120}}>
			  ...
			  <TouchableHighlight underlayColor="#eee" onPress={()=>this.myAct()}>
			    <View style={{flexDirection:'row',height:120}}>
			      <View style={{flex:1,alignItems:'flex-start',justifyContent:'flex-start'}}>
			        <View style={{height:80,width:80,marginTop:10,marginLeft:5,backgroundColor:'white'}}>
<Image></Image><Text>图片</Text>
				    </View>
			      </View>
			      <View style={{flex:3,alignItems:'flex-start',justifyContent:'flex-start',marginLeft:10}}>
