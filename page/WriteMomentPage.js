		  ...
		  <View style={{
            ...
            style={[styles.input, {
			  ...
			  <View style={{
			    ...
			    <Image source={require('./../res/writeMoment/position.png')} style={{
                width: 25,
                height: 25,
                marginLeft: 25,
                marginRight: 20
				...
				<Image source={require('./../res/writeMoment/emoji.png')} style={{
                width: 25,
                height: 25,
                marginLeft: 10,
                marginRight: 20
            }}/>
				<Image source={require('./../res/writeMoment/at.png')} style={{
                width: 25,
                height: 25,
                marginLeft: 10,
                marginRight: 20
