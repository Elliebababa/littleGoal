...
class MomentScreen extends React.Component{
  ...
  static navigationOptions =(navigation)= {
	...
	<TouchableHighlight onPress={()=>{}} underlayColor="#eee">
	  <Image source={require('./../res/Moment/newAct.png')} style={{margin:10,width:30,height:30}}/>
	</TouchableHighlight>),
	headerTitleStyle:{
	    fontWeight:'normal',
		color:'#2196F7',
	  ...
	  return(
	    <View style={{flexDirection:'row',flex:1,height:120}}>
		  <View style={styles.imgArea}>
		    <View style={{height:95,width:95,borderRadius:95,backgroundColor:'gray'}}>
			</View>
		  </View>
		  <View style={[styles.actArea,{borderBottomWidth:1}]}>
			...
			<View style={{flex:1,flexDirection:'row'}}>
			  ...
			  <View style={{flex:1,flexDirection:'row'}}>
			    <TouchableHighlight underlayColor="#eee" onPress={()=>{}}>
				  <View>
				    <Image source={require('./../res/Moment/like.png')} style={{height:20,width:20}}/>
				  </View>
				</TouchableHighlight>
				<Text> 1 </Text>
			  </View>
